	...
	def meta_training(self,train=True):
		...
		for e in range(self.num_epochs):
			...
			if train:
				...
				model_index = int(sys.argv[8])
				npy.save("validation.npy".format(model_index),self.predicted_labels)
				npy.save("validation_painted.npy".format(model_index),self.painted_images)
