...
class hierarchical():
	...
	def initialize_tensorflow_model(self, sess, model_file=None):
		...
		self.conv_strides = npy.array([1,1,2,2,2])
...
def parse_arguments():
	...
	parser.add_argument('--hlambda',dest='hlambda',type=float)
