...
class Parser():
	...
	def select_rule_learner_greedy(self):
		...
		rule_probabilities = self.sess.run(self.ACModel.actor_network.rule_probabilities, feed_dict={self.ACModel.input: input_image,
	...
	def update_target_network(self):		
		# Run target network update operation.
		self.sess.run(self.ACModel.copy_operation)
