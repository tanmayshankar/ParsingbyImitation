...
class PlotManager():
	...
	def __init__(self, to_plot=False, parser=None):
		...
		if self.plot:
			...
			self.sc1 = self.ax[0].imshow(self.parser.predicted_labels[image_index],aspect='equal',cmap='jet',extent=[0,self.parser.image_size,0,self.parser.image_size],origin='lower')
			...
			self.sc2 = self.ax[1].imshow(self.parser.true_labels[image_index],aspect='equal',cmap='jet',extent=[0,self.parser.image_size,0,self.parser.image_size],origin='lower')
			...
			self.sc3 = self.ax[2].imshow(self.parser.images[image_index],aspect='equal',cmap='jet',extent=[0,self.parser.image_size,0,self.parser.image_size],origin='lower')
			...
			self.sc4 = self.ax[3].imshow(self.parser.true_labels[image_index],aspect='equal',cmap='jet',extent=[0,self.parser.image_size,0,self.parser.image_size],origin='lower')
