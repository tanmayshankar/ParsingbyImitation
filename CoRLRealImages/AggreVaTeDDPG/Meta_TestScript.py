...
for i in range(0,500,5):
	...
	command = "python ../Meta_RLClass.py --images ../../../ImageSets/NEW350BINLABS.npy --labels ../../../ImageSets/NEW350BINLABS.npy --indices ../../../ImageSets/TrainIndices.npy --train 0 --gpu 1,2 --reg 1 --model saved_models/model_epoch{0}.ckpt --suffix model_trainval_{0}".format(i)
	subprocess.call(command.split(),shell=False)
	command = "python ../Meta_RLClass.py --images ../../../ImageSets/NEW350BINLABS.npy --labels ../../../ImageSets/NEW350BINLABS.npy --indices ../../../ImageSets/TestIndices.npy --train 0 --gpu 1,2 --reg 1 --model saved_models/model_epoch{0}.ckpt --suffix model_test_{0}".format(i)
	subprocess.call(command.split(),shell=False)
