...
for i in range(10,260,10):
	...
	# FOR FULL PARSING:
	command = "python ../Meta_RLClass.py --images ../../../ImageSets/NEW350BINLABS.npy --labels ../../../ImageSets/NEW350BINLABS.npy --train 0 --gpu 0,1 --depth_terminate --model saved_models/model_epoch{0}.ckpt --suffix model_k20_{0} --infogain 0".format(i)
