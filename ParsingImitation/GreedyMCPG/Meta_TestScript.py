...
# for i in range(8,60):
	...
	command = "python ../Meta_RLClass.py --images ../../../ImageSets/NEW350BINLABS.npy --labels ../../../ImageSets/NEW350BINLABS.npy --indices ../../../ImageSets/TrainIndices.npy --train 0 --gpu 3,1 --model saved_models/model_epoch{0}.ckpt --suffix model_trainval_{0}".format(i)
	subprocess.call(command.split(),shell=False)
	# command = "python ../Meta_RLClass.py --images ../../../ImageSets/NEW350BINLABS.npy --labels ../../../ImageSets/NEW350BINLABS.npy --indices ../../../ImageSets/TestIndices.npy --train 0 --gpu 3,1 --model saved_models/model_epoch{0}.ckpt --suffix model_test_{0}".format(i)
	# subprocess.call(command.split(),shell=False)
