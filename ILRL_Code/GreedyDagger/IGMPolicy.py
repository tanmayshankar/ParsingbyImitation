...
class InformationGainMaximization():

	def __init__(self):


	def infogain(self, image_segment, location, axis):
	...
	def entropy(self, image_segment):
	...
	def best_valid_split(self, image_segment_input, rule_mask):

		# If there's a valid split rule, it'll select the greedy split that minimizes entropy. 
