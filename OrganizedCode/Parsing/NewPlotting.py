...
class PlotManager():
	...
	def __init__(self, to_plot=False,parser=None,data_loader=None):
		...
		self.sc1 = self.ax[0].imshow(self.parser.predicted_labels[image_index],aspect='equal',cmap='jet',extent=[0,self.image_size,0,self.image_size],origin='lower')
		...
		self.sc4 = self.ax[3].imshow(self.data_loader.true_labels[image_index],aspect='equal',cmap='jet',extent=[0,self.image_size,0,self.image_size],origin='lower')
