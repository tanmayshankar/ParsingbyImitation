...
import DaggerPenaltyLearntParser
import NewPlotting
import Memory
...
class Meta_RLClass():
	...
	def __init__(self, session=None,arguments=None):
		...
		if self.args.penalty:
			self.parser = DaggerPenaltyLearntParser.Parser(model_instance=self.model, data_loader_instance=self.data_loader,
...
def parse_arguments():
	...
	parser.add_argument('--penalty',dest='penalty',type=int,default=0)
