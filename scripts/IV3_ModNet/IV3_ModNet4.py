...
class ModularNet():
	...
	def define_split_stream(self):
		...
		self.split_loss_weight = [keras.backend.variable(npy.zeros((1,1)),name='split_loss_weight{0}'.format(j)) for j in range(2)]
	...
	def define_primitive_stream(self):
		...
		self.primitive_loss_weight = keras.backend.variable(npy.zeros((1,1)),name='primitive_loss_weight')
