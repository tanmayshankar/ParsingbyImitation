...
class hierarchical():
	...
	def meta_training(self):
		...
		sc1 = ax[0].imshow(self.predicted_labels[image_index],aspect='equal')
		sc1.set_clim([0,2])
		# fig.colorbar(sc1, ax=ax[0])
		ax[0].set_title("Predicted Labels")
		ax[0].set_adjustable('box-forced')

		sc2 = ax[1].imshow(self.true_labels[image_index],aspect='equal')
		sc2.set_clim([-1,1])
		# fig.colorbar(sc2, ax=ax[1])
		ax[1].set_title("True Labels")
		ax[1].set_adjustable('box-forced')

		sc3 =ax[2].imshow(self.painted_image,aspect='equal')
		sc3.set_clim([-1,1])
		# fig.colorbar(sc3, ax=ax[2])
		ax[2].set_title("Painted Image")
		ax[2].set_adjustable('box-forced')

		sc4 = ax[3].imshow(self.images[image_index],aspect='equal')
		sc4.set_clim([-1,1])
		# fig.colorbar(sc4,ax=ax[3])
		ax[3].set_title("Actual Image")
		...
		# for e in range(2):
			...
			# for i in range(20):
				...
				sc1.set_data(self.predicted_labels[i])
				sc2.set_data(self.true_labels[i])
				sc3.set_data(self.painted_image)
				sc4.set_data(self.images[i])
				fig.canvas.draw()
