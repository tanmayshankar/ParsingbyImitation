...
class hierarchical():
	...
	def initialize_tensorflow_model(self, sess, model_file=None):
		...
		# self.conv_num_filters = npy.array([3,20,40,40,50,50,80],dtype=int)
		self.conv_num_filters = npy.array([3,20,20,20,20,20,20],dtype=int)
		self.conv_strides = npy.array([1,1,1,2,2,2])
		...
		self.fc_input_shape = 31*31*self.conv_num_filters[-1]
